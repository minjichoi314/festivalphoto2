...
카메라 원본 배경으로 네 장을 촬영해 초록색 칠판 분필 그림 2×2 프레임의 JPG를 만듭니다. 공연장 가상 배경과 인물 분리 기능은 제거했습니다. 촬영 시점의 기기 날짜가 프레임에 표시됩니다. 다운로드는 브라우저에서 처리하고, 이메일 전송 때만 사진과 주소를 Google Apps Script 웹 앱으로 보냅니다.
